...
const storyData = [
  ...
  },
  {
    ...
    choices: [
      { text: '연구소장에게 접근해 신뢰를 얻는다.', next: 5, stat: 'persuasion' },
      { text: '연구소를 몰래 빠져나온다.', next: 6, stat: 'exploration' }
    ]
  },
  {
    text: `연구소장에게 접근해 신뢰를 얻으려 합니다.\n연구소장은 당신을 유심히 바라보며, “외계 신호에 대해 어떻게 생각하나?”라고 묻습니다.`,
    choices: [
      { text: '“평화적 교류의 신호일 수 있습니다.”', next: 7, stat: 'persuasion' },
      { text: '“위험하니 봉인해야 합니다.”', next: 8, stat: 'exploration' },
      { text: '“인류의 발전에 쓸 기회입니다.”', next: 9, stat: 'hacking' }
    ]
  },
  {
